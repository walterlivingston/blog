...
![sampled data](/assets/img/bounding-boxes-bounding-ellipsoids/step-3-aa.png)
```python
# axis-align data
...
![sampled data](/assets/img/bounding-boxes-bounding-ellipsoids/step-4-aabb.png)
```python
...
![sampled data](/assets/img/bounding-boxes-bounding-ellipsoids/step-5-obb.png)
```python
